...
const conversParameter = math.matrix;
const converseParMat2 = [
    84.003,
    102.315,
    129.879
];
console.log(math.multiply(mA, mB));
let latitude, longitude;
// (`&nbsp;&nbsp;${r.join(' ')}<br/>`)
var print = (m)=>m.forEach((r)=>convertarea.insertAdjacentHTML("afterbegin", `<div>&nbsp;&nbsp;${r.join(" ")}<br/></div>`));
var a = [
    [
        8,
        3
